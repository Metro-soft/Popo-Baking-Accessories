...
const estimatesRoutes = require('./modules/sales/estimates.routes');
...
const dispatchRoutes = require('./modules/sales/dispatch.routes');
...
app.use('/api/activity', authenticateToken, activityRoutes); // Activity Logs
